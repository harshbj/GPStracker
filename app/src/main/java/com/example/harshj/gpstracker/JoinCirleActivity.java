...
public class JoinCirleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_join_cirle);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            Toast.makeText(getApplicationContext(),"user join circle succ",Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
                    ...
                    Toast.makeText(getApplicationContext(),"Circle code not present",Toast.LENGTH_SHORT).show();
